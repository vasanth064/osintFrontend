import { BiUserCircle, BiCurrentLocation, BiSolidPhoneCall } from "react-icons/bi";
import { BsDatabaseFillExclamation, BsBank, BsGlobe, BsFillCalendarWeekFill, BsFillPhoneVibrateFill, BsPersonVcard, BsDatabaseFillGear } from "react-icons/bs";
import {
  FaMobileAlt,
  FaAddressBook,
  FaLinkedin,
...
export const summaryNodes = [
  {
    id: "A",
    type: "input",
    data: { label: <IconNode icon={<FaFilter />} text="Filter Data using various filters" /> },
    position: { x: 500, y: 0 },
  },
  {
    id: "A-1",
    data: {
      label: <IconNode icon={<BsDatabaseFillGear />} text="Dumped data from cellphone towers" />,
    },
    position: { x: 0, y: 300 },
    parentNode: "A",
  },
  ...
  {
    id: "A-3",
    data: { label: <IconNode icon={<BsFillPhoneVibrateFill />} text="By Phone Number" /> },
    position: { x: 400, y: 300 },
    parentNode: "A",
  },
  {
    id: "A-4",
    data: { label: <IconNode icon={<BiSolidPhoneCall />} text="Filter by Call-type" /> },
  ...
  {
    id: "A-6",
    data: { label: <IconNode icon={<BsFillCalendarWeekFill />} text="FIlter by Date & Time" /> },
  ...
  {
    id: "A-8",
    data: { label: <IconNode icon={<FaPeopleGroup />} text="Common B Party among Numbers" /> },
    position: { x: 1400, y: 300 },
    parentNode: "A",
  },
  {
    id: "A-9",
    data: { label: <IconNode icon={<LiaBroadcastTowerSolid />} text="Dumped Data 1" /> },
    position: { x: 0, y: 600 },
    parentNode: "A",
  },
  {
    id: "A-10",
    data: { label: <IconNode icon={<LiaBroadcastTowerSolid />} text="Dumped Data 2" /> },
